      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <div className="bg-gradient-to-br from-orange-50 via-white to-orange-100 rounded-[28px] p-6 sm:p-8 md:p-12 text-center relative overflow-hidden border border-orange-200/50">
             ...
             <h2 className="text-2xl sm:text-3xl md:text-4xl font-display font-bold text-transparent bg-clip-text bg-gradient-to-r from-neon-purple via-neon-orange to-orange-600 mb-2 relative z-10 drop-shadow-sm">Ready to Transform Odisha?</h2>
             <p className="text-gray-600 mb-6 sm:mb-8 relative z-10 text-sm sm:text-base">Submit your proposal before the deadline.</p>
