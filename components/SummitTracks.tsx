          ...
          {tracks.map((track, i) => (
            ...
            >
              ...
              <div className="relative h-full bg-white/90 backdrop-blur-sm border border-orange-200/50 p-6 rounded-2xl hover:border-neon-orange/50 transition-colors flex flex-col items-center text-center shadow-lg">
                <div className={`w-16 h-16 rounded-full bg-gradient-to-br ${track.color} flex items-center justify-center text-white mb-6 shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                  {track.icon}
                </div>
